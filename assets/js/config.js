const GOMSOFT_CONFIG = {
  ...
  seo: {
    ...
    siteDescription:
      "곰소프트(GOMSOFT)는 앱, 게임, AI·디지털 미디어, 현장 서비스를 직접 기획·개발·운영하는 독립 개발 스튜디오입니다.",
    ogTitle: "곰소프트 GOMSOFT | 앱·웹·AI 서비스를 만드는 개발 스튜디오",
    ogDescription:
      "아이디어를 앱, 웹, AI 서비스로 구현합니다. 곰소프트 GOMSOFT는 기획부터 개발, 출시와 운영까지 직접 수행하는 독립 개발 스튜디오입니다.",
  },
  taglineSub: "아이디어를 실제 서비스로 구현하는 디지털 프로덕트 스튜디오",
  headline: "곰소프트, 아이디어를 실제 서비스로 만듭니다.",
